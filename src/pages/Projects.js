...
function Projects() {
  return (
    <div className="bg-white text-black min-h-screen flex flex-col justify-center">
      <main className="max-w-2xl mx-auto text-left pt-0 px-2 sm:px-4 flex-1 flex flex-col justify-start">
        <div className="mt-8 flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold flex items-center flex-wrap">
              <Link to="/">Elijah Feldman</Link>
              <span className="text-lg mx-2 text-neutral-400 hidden sm:inline">—</span>
              <span className="hidden sm:inline">Projects</span>
            </h1>
          </div>
          <div className="ml-4 sm:ml-8 flex flex-col items-end space-y-2">
            <Link to="/projects" className="text-black hover:underline font-medium">Projects</Link>
            <Link to="/contact" className="text-black hover:underline font-medium">Contact Me</Link>
          </div>
        </div>
        ...
        <div className="mt-8 mb-12">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            <li><a href="#bioblitz" className="hover:underline">BioBlitz</a></li>
          </ul>
        </div>

        <div className="space-y-12">
          <div id="bioblitz" className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 items-start pt-12 border-t border-gray-200">
            <div className="md:col-span-2">
              <p className="text-sm text-gray-500 mb-2">Feb 2025 - Present</p>
              <h3 className="text-xl font-bold text-gray-900 mb-3">BioBlitz</h3>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-gray-100 text-gray-700 text-xs font-medium px-2.5 py-1 rounded-full">Firebase</span>
                <span className="bg-gray-100 text-gray-700 text-xs font-medium px-2.5 py-1 rounded-full">Node.js</span>
                <span className="bg-gray-100 text-gray-700 text-xs font-medium px-2.5 py-1 rounded-full">TypeScript</span>
              </div>
              <div className="flex flex-wrap items-center gap-1 mb-4 text-sm">
                <span className="font-semibold">Links:</span>
                <a href="https://github.com/aarnav593/hacktj25" target="_blank" rel="noopener noreferrer" className="underline font-semibold text-gray-700 hover:text-gray-900">Github</a>
              </div>
            </div>
          ...
          <div id="workflow" className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 items-start pt-12 border-t border-gray-200">
            <div className="md:col-span-2">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="bg-gray-100 text-gray-700 text-xs font-medium px-2.5 py-1 rounded-full">HTML/CSS</span>
                <span className="bg-gray-100 text-gray-700 text-xs font-medium px-2.5 py-1 rounded-full">JavaScript</span>
              </div>
              <div className="flex flex-wrap items-center gap-1 mb-4 text-sm">
                <span className="font-semibold">Links:</span>
                <a href="https://github.com/ElijahFeldman7/workflow" target="_blank" rel="noopener noreferrer" className="underline font-semibold text-gray-700 hover:text-gray-900">Github</a><span>,</span>
                <a href="https://elijahfeldman7.github.io/workflow" target="_blank" rel="noopener noreferrer" className="underline font-semibold text-gray-700 hover:text-gray-900">Workflow Website</a><span>,</span>
                <a href="https://elijahfeldman7.github.io/to-do-list" target="_blank" rel="noopener noreferrer" className="underline font-semibold text-gray-700 hover:text-gray-900">To-Do List Website</a>
              </div>
            </div>
        ...
        <footer className="text-center text-neutral-500 text-sm p-4 flex flex-col items-center space-y-2">
          <div className="flex items-center justify-center space-x-3">
            <a href="https://github.com/ElijahFeldman7" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <svg className="inline-block w-6 h-6 text-black hover:text-gray-700" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
