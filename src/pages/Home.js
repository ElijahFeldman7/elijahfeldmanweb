...
function Home() {
  ...
  return (
    <div className="bg-white text-black min-h-screen flex flex-col justify-center">
      <main className="max-w-2xl mx-auto text-left pt-0 px-4 flex-1 flex flex-col justify-start">
        <div className="mt-8 flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-bold"><Link to="/">Elijah Feldman</Link></h1>
            <div className="text-gray-600 text-lg mt-1">
              <span className="italic">is a <span className="text-black">learner</span>, <span className="text-black">researcher</span>, and</span><br />
              <span className="italic">aspiring <span className="text-black italic">developer.</span></span>
            </div>
          </div>
        ...
        <figure className="mt-4">
          ...
          <figcaption className="mt-2 text-center">
            <span className="block text-gray-500 font-medium italic">In quiet places, we find space to reflect and grow.</span>
            <span className="block text-gray-400 text-sm italic">Glacier National Park, Montana</span>
          </figcaption>
        </figure>
        <p className="mt-6 text-gray-800 leading-relaxed">
        ...
        <figure className="mt-4">
          ...
          <figcaption className="mt-2 text-center">
            <span className="block text-gray-500 font-medium italic">"The Mountains Are Calling and I Must Go"</span> <span className="text-gray-400">- John Muir</span>
            <span className="block text-gray-400 text-sm italic">Yosemite National Park, California</span>
          </figcaption>
        </figure>
        <p className="mt-6 text-gray-800 leading-relaxed">
