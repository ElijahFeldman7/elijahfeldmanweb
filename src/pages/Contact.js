    ...
    <div className="bg-white text-black min-h-screen flex flex-col justify-center">
      <main className="max-w-2xl mx-auto text-left pt-0 px-4 flex-1 flex flex-col justify-start">
        ...
        <div className="flex items-center flex-col sm:flex-row sm:items-center sm:space-x-8 space-y-6 sm:space-y-0 mt-6">
          <a href="mailto:2028efeldman@tjhsst.edu" className="inline-flex items-center gap-2 text-black hover:underline font-medium text-lg">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
            2028efeldman@tjhsst.edu
          </a>
          <a href="https://github.com/ElijahFeldman7" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-black hover:underline font-medium text-lg">
