  ...
  return (
    <footer style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginBottom: '15px' }}>
        <a href="https://github.com/ElijahFeldman7" target="_blank" rel="noopener noreferrer" className="footer-icon-link">
          <svg
        ...
        <a href="https://www.linkedin.com/in/elijah-feldman-a7a0b027b/" target="_blank" rel="noopener noreferrer" className="footer-icon-link">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
